...
from deep_conv_rf import DeepConvRF
...
for fraction_of_train_samples in fraction_of_train_samples_space:
    ...
    best_accuracy = np.mean([run_rf(conv_rf_pp, cifar_train_images, cifar_train_labels, cifar_test_images, cifar_test_labels, fraction_of_train_samples) for _ in range(2)])
...
ax.plot(fraction_of_train_samples_space*100, conv_rf_predict, marker='X', markerfacecolor='red', markersize=10, color='green', linewidth=3, label="Conv RF 2 layer")
