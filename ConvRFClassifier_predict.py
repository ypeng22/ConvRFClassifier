        ...
        for layer in range(self.layers):
            ...
            for i in range(out_dim):
                for j in range(out_dim):
                    ...
                    convolved_image[:, i, j] = self.kernel_forests[layer][i][j].predict(sub_images[:, i, j])[:,None]
        ...
        for layer in range(self.layers):
            ...
            for i in range(out_dim):
                for j in range(out_dim):
                    ...
                    #apply convolution
                    kernel_predictions[:, i, j] = self.kernel_forests[layer][i][j].predict(sub_images[:, i, j])[:,None]
